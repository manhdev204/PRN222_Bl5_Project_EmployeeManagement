...
public partial class Prn222Bl5ProjectEmployeeManagementContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<LeaveRequest>(entity =>
        {
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.LeaveRequestAccounts)
                .HasForeignKey(d => d.AccountId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_LeaveRequest_Account");

            entity.HasOne(d => d.Approved).WithMany(p => p.LeaveRequestApproveds)
                .HasForeignKey(d => d.ApprovedId)
                .HasConstraintName("FK_LeaveRequest_ApprovedId");
        });
